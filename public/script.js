document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function showFieldError(field, message) {
      ...
      errorEl.style.cssText = 'display:block;color:#e53e3e;font-size:0.8125rem;margin-top:0.25rem;';
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'tel' || name.includes('phone') || name.includes('tel')) && !validatePhone(value)) {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .scroll-animate, [data-animate], .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .blog-card, .hero-content, .section-header, .cta-content'
  );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7981d0a1-00d6-4656-afc1-f451bf2a4218',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7981d0a1-00d6-4656-afc1-f451bf2a4218';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7981d0a1-00d6-4656-afc1-f451bf2a4218';
